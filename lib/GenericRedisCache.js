...
const RedisKeyTypeEnum = require('generic-redis-cache-lib/enums/RedisKeyTypeEnum')

const GenericJSONCache  = require('generic-redis-cache-lib/services/types/GenericJSONCache')
const GenericSTRINGCache  = require('generic-redis-cache-lib/services/types/GenericSTRINGCache')
const GenericHASHCache  = require('generic-redis-cache-lib/services/types/GenericHASHCache')
